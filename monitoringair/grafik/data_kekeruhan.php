<?php
    ...
    $sensor_kekeruhan = mysqli_query($koneksi, "SELECT sensor_kekeruhan FROM tb_sensor WHERE ID>='$ID_awal' AND ID<='$ID_akhir' ORDER BY ID ASC");
...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <canvas id="kekeruhan_grafik"></canvas>
        <script type="text/javascript">
        var canvas = document.getElementById('kekeruhan_grafik');
        var data = {
            labels : [
                <?php
            ...
            datasets : [{
                ...
                data : [
                    <?php
                        while($kekeruhan = mysqli_fetch_array($sensor_kekeruhan))
                        {
                            echo $kekeruhan['sensor_kekeruhan'].',';
                        }
                    ?>
                ]
            }]
